...
Для дополнительной информации, как: установка, обучение и ответы на вопросы находятся в [Вики](https://github.com/TheLumiDevs/fakeProfile/wiki). Но перевода там не будет, потому вам придётся читать этот английский вариант.
