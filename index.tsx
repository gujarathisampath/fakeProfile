...
const settings = definePluginSettings({
  ...
  nitroFirst: {
    description:
      "Banner/Avatar to use if both Nitro and fakeProfile Banner/Avatar are present",
      ...
      <Modals.ModalRoot {...props}>
        ...
        <Modals.ModalContent>
          ...
          <div style={{ padding: "0.5em", textAlign: "center" }}>
            <Forms.FormText>
              Disclaimer: This badge is generated by the fakeProfile plugin.
...
export default definePlugin({
  name: "fakeProfile",
  description:
    "Unlock Discord profile effects, themes, avatar decorations, and custom badges without the need for Nitro.",
  authors: [
  ...
  patches: [
    ...
    },
    {
      ...
      replacement: {
        ...
        replace:
          "const vcDecoration=$self.getAvatarDecorationURL(arguments[0]);if(vcDecoration)return vcDecoration;",
      },
    },
    {
    ...
    },
    {
      ...
      replacement: {
        match:
          /getProfileEffectById\((\i)\){return null!=\i\?(\i)\[\i\]:void 0/,
        replace:
          "getProfileEffectById($1){return $self.getProfileEffectById($1, $2)",
      },
    },
  ],
  settingsAboutComponent: () => (
    <Forms.FormSection>
      ...
      <Link href="https://github.com/gujarathisampath/fakeProfile?tab=readme-ov-file#tutorial-about-plugin">
        CLICK HERE TO GET CUSTOM PROFILE EFFECTS, CUSTOM BADGES, BANNER OR
        ANIMATED PFP
      </Link>
      <Forms.FormText>
